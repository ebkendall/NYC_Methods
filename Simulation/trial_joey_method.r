...
for (k in 2:13) {
  ...
  load("~/Desktop/Research/UF/2021/NYC_Methods/Simulation/Results/Investigation/gridPointValues_uniform.rda")
  ...
  save(sim_orig, file = paste0('~/Desktop/Research/UF/2021/NYC_Methods/Simulation/Results/Investigation/sim_orig_',k,'.dat'))
}
...
pdf('~/Desktop/Research/UF/2021/NYC_Methods/Simulation/Results/pValDistr.pdf')
par(mfrow=c(2,2))

for (k in 2:13) {
  
  load(paste0("~/Desktop/Research/UF/2021/NYC_Methods/Simulation/Results/Flat_area/combinedMatchingSetup", k, ".dat"))
  load(paste0("~/Desktop/Research/UF/2021/NYC_Methods/Simulation/Results/Investigation/sim_orig_",k,".dat"))
  ...
  hist(pval, main = paste0("pVal for Buff: ", k*100), 
